            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                <div className="col-span-1 lg:col-span-2 h-full bg-gray-100 min-h-[500px] lg:min-h-[300px] rounded-2xl p-8">
                    ...
                    <p className="text-lg text-gray-700 mt-4">
                        Building sleek, high-performance websites that don’t just look good but feel good to use.
                        Focused on clean design, seamless interactions, and next-level responsiveness.
                    </p>
